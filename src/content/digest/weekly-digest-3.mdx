...
## JavaScript
### [Как писали JavaScript раньше](https://www.trevorlasn.com/blog/revisiting-legacy-javascript)
Ностальгия по эпохе до ES6 — как выглядел код в 2006–2015 годах.

### [6 причин, почему Angular 20 — не такой уж скучный](https://blog.logrocket.com/angular-v20-update/)
Да, Angular развивается не так шумно, как React, но в новой версии много полезных улучшений.

### [🎥 Не используйте JSON.parse и JSON.stringify бездумно](https://www.youtube.com/watch?v=PtcQwb1uBhc)
Короткое видео о подводных камнях сериализации объектов.

## React
### [Состояние React и сообщества в 2025](https://blog.isquaredsoftware.com/2025/06/react-community-2025/)
...
## TypeScript
- [TypeScript компилятор теперь частично на Go](https://devblogs.microsoft.com/typescript/typescript-native-port/)
...
- [GitHub достиг миллиарда репозиториев](https://github.com/AasishPokhrel/shit/issues/1)
...
## 📄 Гайды и статьи
- [Синхронизация данных пользователей с Supabase](https://clerk.com/blog/sync-clerk-user-data-to-supabase?utm_source=frontend&utm_medium=digest&utm_campaign=shabalin_online&utm_content=06-11-25&dub_id=jmpiWYW6SnmZcF2M)
...
**[MSW (Mock Service Worker)](https://mswjs.io/?utm_source=frontend&utm_medium=digest&utm_campaign=shabalin_online)**
...
### [Oxlint 1.0](https://voidzero.dev/posts/announcing-oxlint-1-stable)
