...
- ⏰ [World Clock Slider](https://frontendfoc.us/link/172397/web): интерактивные часы с поддержкой тёмной темы.
- 🔍 [StaticSearch](https://frontendfoc.us/link/172399/web): добавь поиск на любой статический сайт без бэкенда.
- 🧪 [Quickstrom](https://frontendfoc.us/link/172449/web): автоматическое тестирование любых приложений, рендерящих в DOM.
- 🎨 [Oklchroma](https://frontendfoc.us/link/172401/web): генератор цветовых палитр в пространстве OKLCH.
- 🧱 [FossFLOW](https://frontendfoc.us/link/172402/web): создание изометрических схем инфраструктуры.
- 🧑‍💻 [difit](https://frontendfoc.us/link/172404/web): просмотр git-диффов в терминале в стиле GitHub.
- 💻 [7.css](https://frontendfoc.us/link/172405/web): дизайн-система в стиле Windows 7.
- 🖥️ [Polypane 25.1](https://frontendfoc.us/link/172451/web): браузер для верстки с поддержкой DRM.

---

## 🧠 Мнения и размышления

- 💬 [Когда WebAssembly получит поддержку DOM?](https://frontendfoc.us/link/172388/web): всё ещё не скоро, но есть подвижки.
- 💡 [Современный CSS убьёт SPA](https://frontendfoc.us/link/172392/web): интересная точка зрения о возвращении SSR и нативных фич.
- 🧪 [Shadow DOM и Web Components](https://frontendfoc.us/link/172391/web): зачем и как использовать.
- 🌐 [Жидкое стекло в вебе](https://frontendfoc.us/link/172390/web): адаптация нового дизайна Apple в браузерах.
- 🧙 [Интерактивное разрушение текста с WebGPU](https://frontendfoc.us/link/172393/web): магия визуализаций с Three.js и шейдерами.
- 🚀 [Как развернуть сайт на Astro и Netlify](https://frontendfoc.us/link/172396/web): пошаговое руководство для новичков.
- 🛠️ [Производительность и Performance Extensibility API](https://frontendfoc.us/link/172389/web): добавляем свои треки в DevTools.
