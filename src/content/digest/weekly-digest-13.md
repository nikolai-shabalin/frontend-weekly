...
### [Custom Highlight API](https://javascriptweekly.com/link/173227/web)
...
### [Устранение холодных стартов JavaScript в AWS Lambda](https://javascriptweekly.com/link/173264/web)
...
### [jQuery 4.0.0 RC1](https://javascriptweekly.com/link/173273/web)
...
### [Rspack представил Rslint — быстрый линтер на Go](https://javascriptweekly.com/link/173267/web)
...
⚡ В тему: [Oxlint](https://javascriptweekly.com/link/173270/web) на Rust теперь умеет "понимать типы", а также стоит присмотреться к [Biome](https://javascriptweekly.com/link/173271/web), если вас мучает медлительность ESLint.
...
- [Как Bun сделал postMessage быстрее в 500 раз](https://javascriptweekly.com/link/173236/web).
- [Будущее JavaScript: что нас ждёт](https://javascriptweekly.com/link/173237/web).
- [Проблемы модалок и как их решить во Vue.js](https://javascriptweekly.com/link/173235/web).
- [Проектирование AI API в Chrome](https://javascriptweekly.com/link/173231/web).
...
- [Бенчмарк минификаторов JS](https://javascriptweekly.com/link/173274/web) (новичок — [cminify](https://javascriptweekly.com/link/173275/web)).
...
- [Waku 0.25](https://javascriptweekly.com/link/173247/web) — минималистичный React-фреймворк добавил концепцию "slice components".
- [React Date Picker 8.6](https://javascriptweekly.com/link/173251/web) — простой компонент выбора даты ([демо](https://javascriptweekly.com/link/173252/web)).
- [Uppy 5.0](https://javascriptweekly.com/link/173238/web) — модульный загрузчик файлов с поддержкой облачных сервисов и интеграцией с React/Vue/Svelte/Angular.
- [Faceclick](https://javascriptweekly.com/link/173240/web) — лёгкий эмодзи-пикер с поиском.
- [Ky 1.9](https://javascriptweekly.com/link/173249/web) — простой HTTP-клиент на базе Fetch (работает в браузере, Node и Deno).
- [Repomix 1.3](https://javascriptweekly.com/link/173250/web) — упаковывает репозиторий в один файл для удобной работы с LLM.
- [Flatbush 4.5](https://javascriptweekly.com/link/173253/web) — быстрый индекс для работы с 2D-геометрией.
- [plotly.js 3.1](https://javascriptweekly.com/link/173254/web) — библиотека визуализации данных.
- [Chai 6.0](https://javascriptweekly.com/link/173255/web) — фреймворк для тестирования (BDD/TDD).
