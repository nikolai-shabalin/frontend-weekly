...
## ⚛️ React
### [Plate: создаём свой rich-text редактор](https://react.statuscode.com/link/173371/web)
**Plate** — это фреймворк для построения редакторов форматированного текста на базе React. Он позволяет собирать редактор как конструктор: выбирать только нужные функции и расширения. У проекта есть [подробная документация](https://react.statuscode.com/link/173372/web) и [репозиторий на GitHub](https://react.statuscode.com/link/173373/web).

### [Можно ли использовать LocalStorage вместо Context/Redux/Zustand?](https://react.statuscode.com/link/173374/web)
...
### [Streamdown: замена react-markdown с поддержкой стриминга](https://react.statuscode.com/link/173375/web)
...
👉 [Репозиторий GitHub](https://react.statuscode.com/link/173377/web).

### ▶️ [Go to Source в TanStack Devtools](https://react.statuscode.com/link/173382/web)
...
### [Руководство по self-hosting Next.js на продакшене](https://react.statuscode.com/link/173383/web)
...
- [useTransition и переупорядочивание обновлений состояния](https://react.statuscode.com/link/173386/web).
- [Как сделать блог на React 19 и Strapi 5](https://react.statuscode.com/link/173390/web).
...
### [Headless Tree: мощный компонент для деревьев](https://react.statuscode.com/link/173391/web)
Компонент для отображения и работы с иерархическими структурами. В новой версии появилась поддержка множественного выбора.
👉 [Репозиторий GitHub](https://react.statuscode.com/link/173393/web).

### [React-PDF 10.1](https://react.statuscode.com/link/173394/web)
...
- [Konsta UI 5.0](https://react.statuscode.com/link/173400/web) — мобильные UI-компоненты на Tailwind с обновлённым дизайном iOS 26 и Material 2025.
- [React Lite YouTube Embed 2.5.5](https://react.statuscode.com/link/173401/web) — быстрый и приватный способ встраивания YouTube.
- [react-fontawesome 3.0](https://react.statuscode.com/link/173402/web) — официальный компонент для Font Awesome.
- [React Aria (релиз от 25 августа)](https://react.statuscode.com/link/173404/web).
