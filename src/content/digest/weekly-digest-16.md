...
Появился рантайм вокруг движка **Nova** на Rust с обещаниями нативной компиляции в один файл, ускоренного 2D Canvas на GPU и межоп с Rust. Проект молодой, но амбициозный. Посмотреть анонс: [знакомство с Andromeda](https://javascriptweekly.com/link/174239/web). А про движок: [Nova engine](https://javascriptweekly.com/link/174240/web).

- **«Безопасные» методы массивов** — почему `toSorted`, `toSpliced` и др. предпочтительнее мутирующих аналогов; с примерами: [обзор методов](https://javascriptweekly.com/link/174225/web).
- **Микрофронтенды с Module Federation и Vue** — практическая статья с фокусом на сборку и интеграцию: [подход и пример](https://javascriptweekly.com/link/174236/web).
...
Большое фишинговое радио попало к мейнтейнерам и привело к компрометации ряда популярных пакетов — от *Chalk* до *debug*. Если вы публикуете пакеты, включите 2FA и проверьте последние релизы на странные изменения. Подробности и сводка инцидента — в заметке от Socket: [читайте разбор атаки](https://javascriptweekly.com/link/174194/web). Дополнительно: упоминания затронутых пакетов — [Chalk](https://javascriptweekly.com/link/174197/web), [DuckDB для Node.js](https://javascriptweekly.com/link/174199/web), [debug](https://javascriptweekly.com/link/174202/web) и [другие](https://javascriptweekly.com/link/174205/web).
...
Том МакРайт делится практиками «гигиены зависимостей»: чем опасны распухшие `node_modules`, как выявлять неиспользуемое, фиксировать версии и держать скор на CI. Много практических советов и утилит. Начните с этого разбора: [как укротить package.json](https://javascriptweekly.com/link/174187/web).

### Как работает `bun install` изнутри
Лидия Халли из команды Bun разобрала, почему установка пакетов — это сложно в любом менеджере, и как Bun ускоряет процесс: дедупликация, кэширование, разрешение зависимостей и оптимизация файловой системы. Хорошее «погружение под капот» для инженеров. Читайте пост: [за кулисами bun install](https://javascriptweekly.com/link/174190/web).
...
- **Express 5 в продакшене (2025)** — чеклист настройки и лучшие практики: [пошаговый гайд](https://javascriptweekly.com/link/174234/web).
...
- **BlazeDiff** — «огненно‑быстрые» покадровые сравнения изображений как альтернатива `pixelmatch`. История появления и ссылка на репо: [сравнивать картинки быстрее](https://javascriptweekly.com/link/174241/web) (контекст — [почему понадобилась замена](https://javascriptweekly.com/link/174243/web) и [pixelmatch](https://javascriptweekly.com/link/174242/web)).
- **Feedsmith 2.0** — парсинг и генерация RSS/Atom/JSON Feed/OPML, есть быстрый старт для браузера и Node. Подробнее: [работа с фидами](https://javascriptweekly.com/link/174245/web) (см. [квикстарт](https://javascriptweekly.com/link/174246/web) и [репозиторий](https://javascriptweekly.com/link/174247/web)).
- **React Bits** — коллекция из 100+ креативных и анимированных React‑компонентов: текст‑эффекты, «хромо‑сетка», карточки и т.п. Полистать галерею: [придать проекту «вау»‑эффект](https://javascriptweekly.com/link/174249/web) (есть [репозиторий](https://javascriptweekly.com/link/174256/web), дополнительные примеры: [grid](https://javascriptweekly.com/link/174255/web) и [другие эффекты](https://javascriptweekly.com/link/174252/web)).

### Обновления
- **Deno 2.5** — пресеты прав в `deno.json`, улучшения DX в `Deno.test`, программный API для `deno bundle`. Краткий обзор: [что нового в Deno 2.5](https://javascriptweekly.com/link/174208/web).
- **ESLint 9.35.0** — новая проверка `preserve-caught-error`, чтобы не терять исходную ошибку при «обёртывании». Подробнее: [релиз ESLint](https://javascriptweekly.com/link/174210/web) и [описание правила](https://javascriptweekly.com/link/174212/web).
- **Node.js 24.8.0 (Current)** — инспекция HTTP/2 в Chrome DevTools и другие улучшения: [релизная заметка](https://javascriptweekly.com/link/174213/web).
- **Electron 38** — официальная запись релиза: [итоги релиза](https://javascriptweekly.com/link/174214/web).
- **Storybook 10 (beta)** — переход на ESM‑only: [анонс беты](https://javascriptweekly.com/link/174215/web).
- **Ещё**: [Ember 6.7](https://javascriptweekly.com/link/174217/web), [Rspack 1.5.3](https://javascriptweekly.com/link/174219/web), [Expo Router v6](https://javascriptweekly.com/link/174221/web), [Fastify 5.6](https://javascriptweekly.com/link/174222/web).
- **Ink 6.3** — React для CLI‑приложений (его используют многие популярные CLIs): [смотреть релиз](https://javascriptweekly.com/link/174257/web).
